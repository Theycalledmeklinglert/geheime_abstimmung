 ...
 *
 * @param testId Test id set by `id`
 *
 */
export function testIdSelector(cssSelector: string, testId: string): string {
  return `[${cssSelector}="${testId}"]`;
}
 ...
 *
 */
export function findEl<T>(fixture: ComponentFixture<T>,cssSelector:string, testId: string): DebugElement {
  return queryByCss<T>(fixture, testIdSelector(cssSelector, testId));
}
 ...
 * @param testId Test id set by `data-testid`
 */
export function findEls<T>(fixture: ComponentFixture<T>,cssSelector: string, testId: string): DebugElement[] {
  return fixture.debugElement.queryAll(By.css(testIdSelector(cssSelector, testId)));
}
 ...
 * @param testId Test id set by `data-testid`
 */
export function getText<T>(fixture: ComponentFixture<T>,cssSelector: string, testId: string): string {
  return findEl(fixture,cssSelector, testId).nativeElement.textContent;
}
...
export function expectText<T>(
  ...
  expect(getText(fixture,cssSelector, testId)).toBe(text);
}
...
export function setFieldValue<T>(
  ...
  setFieldElementValue(findEl(fixture, cssSelector, testId).nativeElement, value);
}
...
export function checkField<T>(
  ...
  const { nativeElement } = findEl(fixture,cssSelector, testId);
 ...
 * @param testId Test id set by `data-testid`
 */
export function click<T>(fixture: ComponentFixture<T>,cssSelector:string, testId: string): void {
  const element = findEl(fixture,cssSelector, testId);
